            ...
            <div className="sm:border-r-4 sm:mx-4 space-x-2 mb-2 sm:mb-0">
              ...
              <div className="my-8">
                <p className="italic text-sm">
                  Thank you for trusting and purchasing from us. Please check
                  the location in the order and come to receive the product as
                  soon as possible (if you have not paid, please go to the
                  nearest facility to complete the payment)
                </p>
              </div>
            </div>

            <div className="sm:mx-4">
              <h1 className="font-bold text-2xl mt-2 sm:mt-0 mb-6">
                List Order
              </h1>

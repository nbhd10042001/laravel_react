    ...
    <PageComponent title={"Checkout"}>
      {currentUser.id && (
        <div>
          ...
          ></ProcessLayoutVNPay>
          <div className="sm:grid sm:grid-cols-3 sm:max-h-[30rem] sm:gap-2">
            {/* col information */}
            <div className="mt-2 rounded-lg col-span-2 bg-gray-100 p-4">
                  ...
                  <div className="col-span-3">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        valuePhone = valuePhone.replace(/[^0-9]/g, "");
                        setPhoneInput(valuePhone);
                      }}
                    />
                  </div>
                </div>
              ...
              <p className="italic p-4 text-sm text-gray-600">
                ...
                Please go to the car supplier's location to receive your car.
                When you want to return the product, please contact the hotline
                and go to the location where you picked up the car to proceed
                with the return.
              </p>
            </div>
            {/* col list order */}
            <div className="mt-2 rounded-lg col-span-1 bg-gray-100 p-4">
              ...
              <ul className="p-4 h-[15rem] overflow-auto">
                {cart.map((order) => (
                ...
                <div className="mt-4">
                  ...
                  >
                    <PaypalButtonComponent
                      hasPhone={!phoneInput ? false : true}

...
export default function CarCreate() {
  ...
  const handleMaxImages = (ev) => {
    ...
    const total = numberChoose + numberImages;
  ...
  const onSubmit = (ev) => {
    ...
    let response = null;
    if (id) {
      response = axiosClient.put(`/car/${id}`, payload);
    } else {
      response = axiosClient.post("/car", payload);
    }
  ...
  return (
    <PageComponent title={id ? "Update Car" : "Create new Car"}>
